...
guardNotify("Achromatix <3","This script was made by Keanu Reeves#3227, Enjoy!", 1.5, Color3.fromRGB(49, 55, 66), Color3.fromRGB(255, 102, 88), Color3.fromRGB(255, 255, 255), Color3.fromRGB(0, 0, 0), "rbxassetid://6977874681", "Sine")
...
local modeInfo={
   	{Name="Achromatix",Walkspeed=26,moveVal=10,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=9103636254,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='Space'};
	...
	{Name="V I B E R",Walkspeed=16,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=8890040137,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='Poke'};
	...
	{Name="::Chill::",Walkspeed=16,moveVal=4,Font=Enum.Font.Fantasy,StrokeColor=C3.N(1,0,1);Music=9103636254,LeftWing={0,BrickColor.new'Hot pink'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Hot pink'.Color,Enum.Material.Neon};WingAnim='Empty'};
...
WingAnims.Crazed=function()
    LWP1W.C0 = LWP1W.C0:lerp(CF.N(10,-2,-1)*CF.A(M.R(5-20*M.C(WingSine/32)),0,M.R(0+30*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(20,-1,-1)*CF.A(M.R(10-20*M.C(WingSine/32)),0,M.R(15+30*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(40,.5,-1)*CF.A(M.R(15-20*M.C(WingSine/32)),0,M.R(30+40*M.C(WingSine/32))),.2)
 
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-10,-2,-1)*CF.A(M.R(5-20*M.C(WingSine/32)),0,M.R(0-30*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-20.25,-1,-1+.05*M.S(WingSine/20))*CF.A(M.R(10-20*M.C(WingSine/32)),0,M.R(-15-30*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-40,.5,-1)*CF.A(M.R(15-20*M.C(WingSine/32)),0,M.R(-30-40*M.C(WingSine/32))),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-4,.5,-1)*CF.A(M.R(5+0*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(-30,.5,-1)*CF.A(M.R(15-20*M.C(WingSine/32)),0,M.R(-30-35*M.C(WingSine/32))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(30,.5,-1)*CF.A(M.R(15-20*M.C(WingSine/32)),0,M.R(30+35*M.C(WingSine/32))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(50,0,3)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-1000*M.C(WingSine/192))),.2)
end
...
WingAnims.Big=function()
    ...
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(-10,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-2000*M.C(WingSine/192))),.2)
end
...
WingAnims.Lone=function(mult)
    ...
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(0,500,0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-0*M.C(WingSine/192))),.2)
    RWP7W.C0 = RWP7W.C0:lerp(CF.N(-8,.5,-2)*CF.A(M.R(15+2*M.C(WingSine/32)),0,M.R(-30-900*M.C(WingSine/192))),.2)
end
